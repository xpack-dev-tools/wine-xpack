...
upstream {props.upstreamName ? props.upstreamName : 'WineHQ'} project
is a three-number string
such as <code>10.0.0</code>;
...
such as <code>10.0.0-<b>2</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>10.0.0-2.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack WineHQ dependency via
SemVer expressions
such as <code>^10.0.0-2</code> or <code>~10.0.0-2</code>, and
prefer exact matches,
such as <code>10.0.0-2.1</code>.
