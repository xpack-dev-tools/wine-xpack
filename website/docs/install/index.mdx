...
The **xPack WineHQ** can be installed automatically, using the `xpm` command
...
as <a href={ `https://www.npmjs.com/package/@xpack-dev-tools/wine` }><code>@xpack-dev-tools/wine</code></a> from
...
<code>xpacks/@xpack-dev-tools/wine</code>.
...
* create a local symbolic link
  like <code>xpacks/@xpack-dev-tools/wine</code> pointing to the
...
* add links/forwarders into
  ...
  <code>xpacks/@xpack-dev-tools/wine/.content/bin</code>;
* add <code>@xpack-dev-tools/wine</code> to
  `package.json` as a
  development dependency; this associates a specific version of WineHQ with
...
it is also possible to install WineHQ only globally in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/wine /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/wine /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/wine /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
the <a href={ `https://github.com/xpack-dev-tools/wine-xpack/releases/` }>GitHub Releases</a> pages.
...
The Windows versions of **xPack WineHQ**
are packed as `.zip` files.
Download the latest version named like:

* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
To manually install the <b>xPack WineHQ</b>,
unpack the archive and move it to a location of your choice.

The recommended location is
the <code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\wine</code> folder, for
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\wine\\xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
The macOS versions of **xPack WineHQ**
are packed as `.tar.gz` archives.
Download the latest version named like:

* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
The recommended location is
the <code>~/Library/xPacks/wine</code> folder, for
example <code>/Users/ilg/Library/xPacks/wine/xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/wine
cd ~/Library/xPacks/wine

tar xvf ~/Downloads/xpack-wine-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-wine-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
...
* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
* <code>xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm.tar.gz</code>
...
The recommended location is
the <code>~/.local/xPacks/wine</code> folder, for
example <code>/home/ilg/.local/xPacks/wine/xpack-wine-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/wine
cd ~/.local/xPacks/wine

tar xvf ~/Downloads/xpack-wine-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-wine-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
