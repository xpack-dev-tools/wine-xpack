...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fwine?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/wine/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/wine-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fwine?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/wine/)
