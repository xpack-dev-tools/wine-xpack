...
title: How to make new xPack WineHQ releases
...
```sh
rm -f ~/Work/xpack-dev-tools/wine-xpack.git/package-lock.json
git -C ~/Work/xpack-dev-tools/wine-xpack.git pull
...
xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
xpm run trigger-workflow-build-win32-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
```
...
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
```
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
```
...
named like **xPack WineHQ v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/wine@${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') } latest
npm dist-tag ls @xpack-dev-tools/wine`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/wine@${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }`
} </CodeBlock>
...
- paste the release name like _**xPack WineHQ v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
