...
- <code>xpack-wine-10.0.0-3-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
- <code>xpack-wine-10.0.0-3-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
...
xpm run deep-clean --config ${props.platform}  -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets && \\
xpm run docker-prepare --config ${props.platform} -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets && \\
xpm run docker-build --config ${props.platform} -C ~/Work/xpack-dev-tools/wine-xpack.git/build-assets
`} </CodeBlock>
