...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm run generate-website-blog-post -C ~/Work/xpack-dev-tools/wine-xpack.git/website
  ```
...
- **Commit** with the message _**website: blog post release 10.0.0-1.1 published**_
