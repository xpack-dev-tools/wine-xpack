...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/xpack-dev-tools/wine-xpack.git/website run generate-website-blog-post
  ```
...
- **Commit** with the message _**website: blog post release 10.0.0-3.1 published**_
