...
(such as **10.0.0-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v10.0.0-1 released**_
...
tagged such as **v10.0.0-1** (mind the dash in the middle!) and
named such as **xPack WineHQ v10.0.0-1** (mind the dash),
