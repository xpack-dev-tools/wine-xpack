...
and fix them; assign them to a milestone (like <code>10.0.0-1</code>).
...
- add a new entry like _**\* v10.0.0-1 prepared**_
- commit with the message _**prepare v10.0.0-1**_
...
(like **10.0**) with the following expression:
...
tagged like **v10.0.0-1** (mind the dash in the middle!) and
named like **xPack WineHQ v10.0.0-1** (mind the dash),
...
- commit with the message _**website: blog post release 10.0.0-1 published**_
...
- commit all changes with the message
  _**package.json: update urls for 10.0.0-1.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v10.0.0-1.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v10.0.0-1.1**_
...
- paste the release name like _**xPack WineHQ v10.0.0-1 released**_
