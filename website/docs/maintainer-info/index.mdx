...
title: Information for xPack WineHQ maintainers
...
```sh
bash ~/Work/xpack-dev-tools/wine-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
- <code>npm dist-tag ls @xpack-dev-tools/wine</code>
- <code>npm dist-tag add @xpack-dev-tools/wine@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/wine</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/wine@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/wine-xpack/blog/
