...
title: Getting Started with the xPack WineHQ
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/wine-xpack)

## Overview

**xPack WineHQ** is a standalone
 binary
...
[release assets](https://github.com/xpack-dev-tools/wine-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/wine-xpack/tree/xpack/build-assets/scripts).
...
[GitHub Discussions](https://github.com/xpack-dev-tools/wine-xpack/discussions/).
...
[`wine-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/wine-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/wine-xpack/): It helps others discover our work.
