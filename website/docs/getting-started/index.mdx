...
**xPack WineHQ** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of WineHQ,
intended for reproducible builds.

<Overview/>

**xPack WineHQ** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/wine-xpack/tree/xpack/scripts).
