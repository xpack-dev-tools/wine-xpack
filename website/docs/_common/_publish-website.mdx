...
[GitHub Actions](https://github.com/xpack-dev-tools/wine-xpack/actions/workflows/publish-github-pages.yml).
...
- **Push** the `website` branch to GitHub
  ...
  the [website](https://xpack-dev-tools.github.io/wine-xpack/).
  :::
- Check out the `xpack-development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/xpack-dev-tools/wine-xpack/actions/workflows/publish-github-pages.yml) workflow
- **Refresh** the web page
- The new release blog post is available
at https://xpack-dev-tools.github.io/wine-xpack/blog/
