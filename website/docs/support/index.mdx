...
# How to get help for the xPack WineHQ
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/wine-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/wine-xpack/discussions)
pages.
