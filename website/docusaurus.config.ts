...
const config: Config = {
  ...
  tagline: 'A binary distribution of WineHQ',
  ...
  projectName: 'wine-xpack', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/wine-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/wine-xpack/blog/archive/**',
            '/wine-xpack/blog/authors/**',
            '/wine-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/wine-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/wine-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/wine-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/wine-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, wine'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/wine-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/wine-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/wine-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub wine-xpack project',
              href: 'https://github.com/xpack-dev-tools/wine-xpack/',
            },
            {
