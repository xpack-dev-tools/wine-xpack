...
title: xPack WineHQ v10.0.0-3 released
seo_title: Version 10.0.0-3 released
description: Version 10.0.0-3 is a maintenance release.
keywords:
  - xpack
  - wine
  - release

date: 2025-11-01 12:35:17 +0200
...
download_url: https://github.com/xpack-dev-tools/wine-xpack/releases/tag/v10.0.0-3/
...
Version **10.0.0-3** is a maintenance release; it reverts to using the original executable names.
...
Comprehensive instructions for installing **xPack xPack WineHQ** on different platforms
...
```txt
d764273856cf2eea93c1d65abbc0f6210899ab801c331cb51b75c38b50fefc9d
xpack-wine-10.0.0-3-linux-x64.tar.gz
...
<CodeBlock language="console"> {
`$ tree -L 2 ~/.local/xPacks/\@xpack-dev-tools/wine/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
/home/ilg/.local/xPacks/\@xpack-dev-tools/wine/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
├── README.md
├── bin
│   ├── function_grep.pl
│   ├── msidb
