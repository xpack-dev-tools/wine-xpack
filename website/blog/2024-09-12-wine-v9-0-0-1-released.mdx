---
title: xPack WineHQ v9.0.0-1 released
seo_title: Version 9.0.0-1 released
description: Version 9.0.0-1 is a new release of xPack WineHQ.
keywords:
  - xpack
  - wine
  - release

date: 2024-09-12 22:51:17 +0300
...
ninja_release_date: "16 Jan 2024"

version: "9.0.0-1"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/wine-xpack/releases/tag/v9.0.0-1/
...
Version **9.0.0-1** is a new release; it follows the upstream release.
...
- WineHQ release
[{frontMatter.upstream_version}](https://dl.winehq.org/wine/source/{frontMatter.upstream_version_major}.0/) from {frontMatter.upstream_release_date}.
...
```txt
2afae5556a89309ef02b589265b0300e7637b8d0c1ad2c0cdee7a122b735a815
