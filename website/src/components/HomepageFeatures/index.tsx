...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        The <b>xPack Framework</b> aims to automate the installation of <b>multiple versions</b> of development tools that are otherwise not easily available in common software distributions, on <b>GNU/Linux</b>.
      </>
    ),
  },
  {
