...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/wine?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/wine/)
...
A standalone GNU/Linux binary
distribution of WineHQ,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project web site](https://xpack-dev-tools.github.io/wine-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v10.0.0-1.1 tree](https://github.com/xpack-dev-tools/wine-xpack/tree/v10.0.0-1.1).
