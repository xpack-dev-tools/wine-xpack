# Scripts to test the WineHQ xPack
...
The test script is part of the WineHQ xPack:
...
To check if WineHQ starts on the current platform, run a native test:

```sh
bash ${HOME}/Work/wine-xpack.git/scripts/helper/tests/native-test.sh \
...
```sh
bash ${HOME}/Work/wine-xpack.git/scripts/tests/trigger-workflow-test-native.sh \
  --branch xpack-develop \
  --base-url "https://github.com/xpack-dev-tools/pre-releases/releases/download/test/"

bash ${HOME}/Work/wine-xpack.git/scripts/tests/trigger-workflow-test-docker-linux-intel.sh \
  --branch xpack-develop \
  --base-url "https://github.com/xpack-dev-tools/pre-releases/releases/download/test/"

bash ${HOME}/Work/wine-xpack.git/scripts/tests/trigger-workflow-test-docker-linux-arm.sh \
  --branch xpack-develop \
  --base-url "https://github.com/xpack-dev-tools/pre-releases/releases/download/test/"
